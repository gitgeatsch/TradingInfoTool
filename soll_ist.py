...
REIHENFOLGE = (
    ...
    Schritt(44, "DIE KETTE GERADEZIEHEN - TRICHTER, WAECHTER, "
            ...
            "191 betriebszustand. (2) NICHTS_TUN AUS DEM TRICHTER: es ist "
            "eine ANTWORT, kein Filter. Die Zelle laeuft weiter durch "
            "Geometrie und Entscheider, die DETERMINISTISCHE Bewertung "
            "entscheidet, der Einwand des Sprachmodells steht in der Mail. "
            "Das setzt die Nutzervorgabe ,Entscheidungshilfe, nichts "
            "blockieren' um UND macht erst messbar, ob das Modell recht "
            "hatte. (3) EIGENE SICHTBARE SPUR FUER DIE DREI LLM-STELLEN und "
            ...
            "und Z.ai in 60 von 163 Faellen widerspricht. (4) DER "
            "WIDERLEGUNGSPREIS RAUS AUS DER GEOMETRIE - zur Entscheidung "
            "vorgelegt (2.391-hilfe): heute bestimmt eine Angabe von LLM-1 "
            "Rolle BC die Stopweite und damit Betrag, Hebel und Ziel. Das "
            "ist AENDERN, nicht HELFEN. Vorschlag: Geometrie rechnet ohne "
            "ihn (Rauschboden und Marken), der Preis bleibt als Pruefmarke "
            "in Mail und Positionsfuehrung - dort ist er ohnehin schon "
            "verdrahtet. (5) ERST DANN SCHRITT 42 - die Aussagekraft je "
