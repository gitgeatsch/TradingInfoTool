...
REIHENFOLGE = (
    Schritt(61, "BITPANDA-ANBINDUNG AUF DIE NEUE SCHNITTSTELLE - BESTAND, CASH, STAKING, HEBEL",
            ...
            "Watchlist-Eintrag nie stumm verwerfen - \u2714 G2X, BW, ROL: Nutzerentscheidung 15.09. Watchlist, "
            "eingetragen (2.455-kurs-od7-gebaut). "
            ...
            "Teilverkauf; manuelle Einstaende bleiben - HEIKEL, abstimmen. STUFE 3 HEBEL-ABGLEICH (PRUEFFALL: der Nutzer eroeffnet im Anlassfall eine Hebelposition, sobald die Hebel-Empfehlungen tragen - daran wird gemessen, ob `/portfolio` die Hebel-Wallet mitzaehlt und ob `hebel_positions` aus den neuen Buchungen stimmt) auf die neuen "
            "Buchungen (0.2 positiv). STUFE 4 Katalog ,gelistet' auf die neue API (2.455-gelistet-katalog: der alte v3-Katalog kennt X136, "
            "ISOC, BW und G2X nicht, 11 Werte haengen an einem handgesetzten Kennzeichen; der neue Katalog fuehrt 14.052 statt 3.242 Eintraege in NEUEN Gruppen (equity_stock, equity_etf, "
            "equity_complex_*) - `NON_CRYPTO_ASSET_GROUPS` muss mit, sonst sucht der Screener weiter in 179 statt "
            "2.625 ETFs; er fuehrt "
            "alle mit ISIN). "
    ...
    Schritt(56, "DATENQUELLEN OHNE FRISCHE - DIESELBE KLASSE WIE 2.452",
            ...
            "2.452-boerse (OI nur von Binance) und 2.452-anlass. (10) AUS DEM REVIEW 15.09. (2.455-review) - VIER PUNKTE MIT DEM VERMERK ,NACH DEM ROLLOUT', die an erledigten Schritten hingen: 2.387-job (Portfoliowert-Job schrieb 01. bis 11.09. nicht; Sicherung 14.09. 22:40: seit dem Rollout 12.09. je Tag eine Zeile - 11.09., 12.09., 13.09.; offen nur, ob der 04:30-Lauf ohne Neustart schreibt, am naechsten Tag an der Zeile 14.09. bestaetigen), 2.387-fortschreibung (Boersentitel fortgeschrieben; Export 14.09.: 38 Symbole, 0 ohne Kurs - gegen 2.453-kurs-gebaut pruefen), \u2714 GELOEST 15.09. 2.382-rundung (2.455-hebelstufen-gebaut: ein ungerundeter Hebel, in der Mail die einstellbaren Stufen, die untere hervorgehoben). (11) 2.455-refreshzeit: Kursreihen-Tagesjob 24 h nach App-Start statt fester Uhrzeit. (12) \u26a0\ufe0f\u26a0\ufe0f AUSSTEHENDE NOTEBOOK-KONTROLLEN [STAND 17.09. 06:42, Export nach Pull b417f28: \u2714 K1-K4, K7-K10, K11 (bis auf die Cash-Zeile in einer Kaufmail - Nutzerblick), K12, Papierkorb-Buch und Spaltendrift bestaetigt; K5 erster Tag \u2714 (sechs Ersetzungen 0,00 Prozent, echter Vergleich gegen die Yahoo-Zeile), weitere Tage beobachten; K6 zwei echte Hebelmails NEAR 16.09. 19:13 und 22:50 - Stufen im Mailtext vom Nutzer bestaetigen (Text nicht gespeichert)] (Nutzervorgabe 15.09.: ,anstehende Pruefungen nicht vergessen und sauber in Plan und Memory mitfuehren') - ein Punkt gilt erst als erledigt, wenn er am Notebook bestaetigt ist: (K1) Pull von `2.455-hebelstufen-gebaut` mit Neustart UND Export nach rund 30 Minuten (Nutzervorgabe 15.09.: ,alle groesseren Aenderungen sollten auf Fehler im Betrieb durchgeprueft werden, sonst verschleppen wir Fehler') - geprueft wird: seit dem Start kein neuer ERROR/Traceback in rollen_lauf, entscheidungsrechnung, signal_mail, hebelfuehrung; jeder Umlauf ,0 Fehler'; keine ,uebersprungen'-Zeile der Hebelfuehrung oder Positionsfuehrung; Jobfehler nur mit bekannter Ursache; (K2) Export 16.09. NACH 06:45: 05:30 erster Lauf `refresh_aktien_ohlc` nach neuer Regel, ggf. Zeilen ,Kursluecke ...' (2.455-kapitalkurse-gebaut); (K3) 06:30 `Tageswert 2026-09-15` OHNE fortgeschriebene Boersentitel; (K4) 2.387-job - die Zeile 15.09. schreibt der 06:30-Lauf OHNE Neustart; (K5) in den Tagen danach die Selbstpruefung ,Schlusskurs-Rueckfall ... ersetzt' mit Abweichung unter 0,5 Prozent; (K6) die erste echte Hebelmail nach dem Pull zeigt die Stufen wie am Pruefstand; (K7) Hebel-Abgleich und Datenfrische weiter ohne Alarm; (K8) OD7-Korrektur (2.455-kurs-od7-gebaut): nach Pull "
            "und Neustart zeigt `price_cache` OD7H rund 36 und OD7C rund 47 EUR, der 05:30-Lauf schreibt ,ETC-Reihe fuer "
            "OD7H rekonstruiert ... Anker rund 42 USD' und ,Kursangaben geprueft: 16 Werte, 0 tot'; der Tageswert steigt "
            "um rund 420 EUR OHNE Indexsprung; der Bitpanda-Abgleich legt Bestaende fuer G2X, BW, ROL an; die Datenfrische "
            "meldet keine Kursangabe - ✔ BESTAETIGT 16.09. 06:49: Anker OD7H 41,94 USD (36,45 EUR), OD7C 54,26 USD (47,15 EUR), 520 Punkte; ,Kursangaben geprueft: 16 Werte, 0 tot'; Aktien-OHLC 4 von 4 (BW und ROL neu), Kursluecke G2X gefuellt; Tageswert 15.09. 18.421,52 EUR aus 41 Symbolen, 0 ohne Kurs; Index -3,08 Prozent EXAKT aus den Kursen nachgerechnet (BTC -3,2, ETH -4,5, LINK -5,2, TAO -6,1 Prozent), OD7H und OD7C zusammen +1,60 EUR - KEIN Korrektursprung; (K9) ✔ BESTAETIGT 15.09. 21:36 Krypto-Preisabruf (2.455-preis-ueberlauf): nach Pull und Neustart keine Zeile "
            ",Preis-Refresh fehlgeschlagen' mehr, ,Preis-Refresh: 4x/5x Assets aktualisiert', gegebenenfalls ,CoinGecko-"
            "Volumen fuer ETH verworfen'; ETH/SOL in `price_cache` wieder aktuell; offen fuer 56/60: `price_cache` hat "
            "keine Datenfrische; (K10) NEUER BESTANDSABGLEICH (2.455-bestand-neu-gebaut): nach Pull und Neustart erster Lauf rund 90 s (Katalog und volle Buchungshistorie), Log ,Bitpanda-Bestandsabgleich: N aktualisiert' mit den Staking-Korrekturen wie im Trockenlauf (ETH, SUI, TAO, SOL, NEAR, AVAX, HYPE, BNB), KEIN Signal faelschlich bestaetigt (BNB-REDUZIEREN bleibt offen), keine Zeile ,nicht uebernommen'; zweiter Lauf wenige Sekunden; Tageswert am Folgetag rund 2.440 EUR niedriger OHNE Indexsprung; beim ersten offenen Hebel im Log, ob `/portfolio` die Hebel-Wallet mitzaehlt. NUTZERANGEBOT 16.09.: er eroeffnet dafuer im Anlassfall eine Hebelposition - ABER ERST, wenn die Hebel-Empfehlungen funktionieren (Schritte 59/60); bis dahin bleibt die Frage offen, der Abgleich akzeptiert beide Lesarten und protokolliert die zutreffende. Ablauf und erwartete Zeilen: Basisinfos/Rollout_Notebook_14_09.md, Nachtraege 15.09. "
            ...
            block="D-BETRIEB",
            umbau="alt"),  # Reparatur
    Schritt(65, "HISTORIE FUER OPTIONSMARKT UND STABLECOIN BESCHAFFEN (OFFEN)",
            '⚠️ ANLASS (20.09.2026, Befund 2.483-datenlage, Nutzerentscheidung E5). ZWEI GROESSEN STEHEN REGISTRIERT UND SIND NICHT MESSBAR, weil die HISTORIE FEHLT - nicht, weil die Methode fehlt: `defillama/stablecoin_angebot_usd` und die vier Deribit-Reihen (BTC_dvol, BTC_skew, ETH_dvol, ETH_skew) haben je 34 Punkte, gesammelt seit dem 17.08.2026. Die Norm verlangt rund 20 Bloecke; bei H20 sind das 1.200 Tage, also 2029. WARTEN IST KEINE OPTION. ➔ ZU TUN: die Historie bei den Anbietern nachladen - DefiLlama fuehrt Stablecoin-Reihen seit 2018, Deribit DVOL seit 2021. Danach messen wie jeden anderen Kandidaten. ⚠️⚠️ REIHENFOLGE, NUTZERHINWEIS 20.09.: der OPTIONSMARKT ZUERST. Woertlich: *zum Optionsmarkt BTC ein Hinweis - dieser koennte zukuenftig unter Umstaenden etwas beitragen.* Fachlich traegt das: erwartete Schwankung (DVOL) und Schieflage der Absicherungskosten (Skew) sind die EINZIGEN Groessen im Bestand, die etwas ueber die ERWARTUNG des Marktes sagen statt ueber seine Vergangenheit - alles andere, was wir messen, ist rueckwaertsgewandt. ⚠️ ZU KLAEREN VOR DEM LADEN: (1) ob die Anbieter die Historie kostenfrei herausgeben (Vorgabe: nur kostenfreie Quellen); (2) in welcher Aufloesung - taeglich genuegt; (3) ob die nachgeladene Reihe zu der selbst gesammelten passt, sonst entsteht ein Bruch in der Mitte (dieselbe Pruefung wie bei der turnover-Quelle, 2.410). ⚠️ NICHT VOR M1: Krypto-Einstieg geht vor',
            'Befunde 2.483-datenlage, 2.459-ungemessen, 2.453-alterlos; agent/positionierung._stablecoin und _optionsmarkt; externe_reihe in der Produktionssicherung 19.09.',
            block="SPAETER",
            umbau="neu"),
    Schritt(64, "DIE NORM NACHZIEHEN - HYPOTHESE, MEHRFACHVERGLEICH, SAATPROBE (OFFEN)",
            '⚠⚠ ANLASS (19.09.2026, Befund 2.477-stabilitaet): ein TRAEGT-Urteil an der Grenze hielt der Saat nicht stand. B1 (H5) kam auf TRAEGT mit 0,0006 R Abstand zwischen der Bandunterkante und der oberen Nullgrenze; mit fuenf Saaten gemessen trugen davon nur noch 4 von 5, bei zusaetzlicher Mindestbesetzung sogar nur 1 von 5 - und diese eine war die Vorgabesaat. Das Urteil WAR die Saat. ⚠ WAS HIER NICHT BEHAUPTET WIRD: dass andere Befunde betroffen sind. Die Urteile aus 2.476 stehen mit 0,0555 und 0,0568 R Abstand weit von der Grenze und sind es nachweislich nicht. Die Frage ist, OB es knappe gibt. ➔ ZU TUN: (1) alle registrierten TRAEGT-Urteile daraufhin durchsehen, wie weit die Bandunterkante von der oberen Nullgrenze liegt - die Zahl steht nicht ueberall in der Ablage, teils muss sie nachgerechnet werden; (2) fuer alle unter rund 0,005 R Abstand die Saatprobe nachziehen; (3) entscheiden, ob die Probe in `messnorm` selbst gehoert, damit sie kuenftig nicht vergessen wird - dort steht die Blockpruefung bereits als Vorbild, und die war am 06.09. genau deshalb nachgetragen worden. ⚠ NICHT VOR M1: die Krypto-Einstiegsseite geht vor (Vorgabe KRYPTO-ZUERST). Dieser Punkt ist eine Durchsicht des Bestandes, kein Blocker fuer einen laufenden Schritt. ➤ ERWEITERT 19.09.2026 AUF DAS GANZE NORMPAKET (Nutzerentscheidung: ,sieh die Punkte A und B im Plan vor`). ⚠️⚠️ DAS VERFAHREN GIBT ES IM PROJEKT SCHON - es ist nur nie in die Norm gewandert. `agent/krypto/ausschuss_suche.py` (04.08.2026) schreibt woertlich: 43 Merkmale mal rund 9 Schwellen sind knapp 400 Einzelhypothesen, bei naiven 5 Prozent erwartet man rund 20 Funde aus reinem Rauschen - und loest es mit MAX-STATISTIK STATT EINZELTEST, ausdruecklich OHNE Bonferroni und seine Konservativitaet. Das ist Romano/Wolf (Econometrica 2005) in eigenen Worten. ⚠️ WAS BISHER GILT: KEIN Aufrufer hat je `hypothesen` gesetzt, jeder Befund steht auf 1. Wo eine Frage EINE Zelle war, hat die Norm gehalten; betroffen sind nur die Sweeps (HORIZONTE-Laeufe, Mengenlaeufe). ➔ DREI PUNKTE: (A) DIE NORM RECHNET FAMILIENWEIT - Maximum ueber die Zellen aus den VORHANDENEN Nullwelten, kein neues Verfahren. (B) DER BEFUND TRAEGT SEINE HYPOTHESE IM KLARTEXT - Pflichtfeld, GEZOGEN aus `bestand.KANDIDATEN` ueber den Namen, damit nicht zwei Fassungen auseinanderlaufen; heute hat `Befund` nur `kandidat` (Name) und `hypothesen` (Anzahl). (C) JEDE MESSUNG NENNT DEN REGISTRIERTEN KANDIDATEN, dessen Hypothese sie prueft, und die Norm weist es ab, wenn es keinen gibt. STUFEN bekommen dafuer einen VERWEIS, kein eigenes Blatt: `auswahl` auf `momentum`, `terminmarkt` auf `oi_aenderung` - sonst stuende die Hypothese zweimal. ⚠️ WARUM (C) noetig ist: am 19.09. wurde die Stufe `auswahl` gemessen, OHNE dass die registrierte Hypothese auftauchte - sie stand die ganze Zeit im Kandidatenblatt `momentum` (,wer gestiegen ist, steigt weiter`), und die Auswahl ist nichts anderes als deren Anwendung. ⚠️ NICHT IN DIESEM PAKET: die Begruendung im BETRIEB. In `agent/`, `scheduler/` und `ui/` kommt `hypothese` nicht vor - die Kette Hypothese zu Begruendung zu schliessen gehoert zu Schritt 33. ⚠️ R-R11: (A) kann knappe Mehrzell-Urteile bewegen; jedes betroffene gehoert zuerst reproduziert. (B) und (C) aendern KEINE Zahl. ⚠️ NICHT VOR M1',
            'Befunde 2.477-stabilitaet, 2.477-basisvarianten, 2.476-verkaufsregel; phase3_verkaufsregel_basis.stabilitaet; messnorm.pruefe_block (das Vorbild); agent/krypto/ausschuss_suche.py (Max-Statistik, 04.08.2026); Harvey/Liu/Zhu und Romano/Wolf (Econometrica 2005) als Methodik; messnorm.Befund (Felder `hypothesen`, `frageart`); bestand.Kandidat.hypothese (22 von 22 gefuellt); Befund 2.479-auswahlstufe',
            block="SPAETER",
            umbau="neu"),
    Schritt(63, "SHORT-SEITE - ZIELGROESSE FESTLEGEN, DANN MESSEN (OFFEN)",
            "⚠⚠ ZWEI VERSCHIEDENE SHORT-SPERREN - UND HIER GEHT ES NUR UM DIE ZWEITE (praezisiert auf Nutzerrueckfrage 19.09.). (1) DIE HANDELBARKEITS-SPERRE: `budget_allocator.hebel_richtung_modus = nur_long`, gelesen von `asset_schalter.mail_richtung_erlaubt`. Begruendung in der config: Bitpanda kann Hebel-Short nicht ausfuehren - also BROKER, nicht Fachlichkeit. Sie verhindert NUR Mail und GUI; das Signal entsteht, wird gebucht und weiter gemessen (Nutzervorgabe 05.08.: der Schalter soll NULL Einfluss auf die Funktionsweise im Hintergrund haben - der Grund war Messhygiene: vorher lagen 313 SHORT-Vorschlaege als HALTEN in der Datenbank und verzerrten jede Auswertung nach Richtungen). (2) DIE MESS-SPERRE, und die ist hier gemeint: `messnorm.Lage` wirft bei `richtung` gleich short - null Signale in der Produktion, Zielgroesse offen, erst festlegen, dann messen. Sie verhindert das URTEILEN, nicht das Handeln. ➔ WICHTIG FUER DIE PLANUNG: Sperre (1) muss dafuer NICHT fallen. Short laesst sich messen, solange die Signale entstehen und gebucht werden - und das tun sie. Ob danach gehandelt werden kann, ist eine getrennte Frage an den Broker, und die beantwortet keine Messung. Der Punkt steht hier, damit er nicht liegenbleibt (Nutzervorgabe 19.09.: *,die Short-Seite trage in den Gesamtplan ganz am Ende als offenen Punkt ein, sonst bleibt er liegen`). LAGE: `messnorm.Lage` wirft bei `richtung='short'` ausdruecklich - *,SHORT ist noch nicht geklaert - null Signale in der Produktion, Zielgroesse offen. Erst festlegen, dann messen`*. Es gibt also keine Long/Short-Messung, sondern eine bewusste Blockade. ⚠ WAS ZU KLAEREN IST, BEVOR GEMESSEN WIRD: (1) die ZIELGROESSE - `bewegung_r` ist richtungsbereinigt definierbar, aber fuer Short sind Finanzierungskosten und Liquidationsrisiko andere; (2) ob es ueberhaupt eine HANDELBARE Umsetzung gibt (Bitpanda: Hebel nur Krypto, Kapitel 88.3); (3) ob die gemessenen Beitraege fuer Short gelten - nach 2.287 (Akkumulation laeuft umgekehrt) ist das NICHT zu unterstellen. ⚠⚠ UND DER ZUSAMMENHANG MIT DER VERKAUFSSEITE, der den Punkt erst dringend macht: die Nutzerfrage vom 19.09. lautete, ob sich beim Verkauf auf Bestehendem aufbauen laesst - Hebel und Short waeren die naheliegenden Kandidaten fuer ,der Kurs faellt gleich` (Verkaufsfall 4, Absicherung), und genau fuer diesen Fall gibt es heute KEINE Grundlage (2.470). Ein tragfaehiges Short-Mass waere damit zugleich die fehlende Grundlage der Absicherung. → NICHT VOR M1: die Krypto-Einstiegsseite geht vor (Vorgabe KRYPTO-ZUERST), und der Hebel ist ueber A1 abgedeckt.",
            "Nutzervorgabe 19.09.2026 (ganz ans Ende des Gesamtplans); messnorm.Lage (Short-Sperre); Befunde 2.287, 2.470-verkauf-basislinie",
            block="SPAETER",   # ausdruecklich ans Ende, nicht vor M1
            umbau="neu"),      # es gibt heute nichts Kurzes, das ersetzt wuerde
    ...
    Schritt(43, "VERKAUFSEMPFEHLUNGEN - DIE AUSSTIEGSSEITE ZU ENDE BAUEN",
            ...
            "davor). \u27a4 NUTZERENTSCHEIDUNGEN 14.09. (Plan_Asset_Lebenszyklus_14_09.md, Abschnitt Ausstieg): (A) VERKAUFEN UND REDUZIEREN GEHOEREN GEMESSEN und sauber ins Konzept - WAS ist der Verkaufsgrund: eine BEWERTUNG je Strategie; die noetigen Bewertungen und Urteile werden mit dem Nutzer dimensioniert wie beim Einstieg. \u26a0\ufe0f DIE VERKAUFSBEWERTUNG IST NICHT GELOEST - Stand 14.09. unveraendert 2.392. (B) HEBEL: Schutzschicht = Regeln alle 15 min mit eigenem Betreff und Mailhinweis; Fuehrung = Modell mit Positionskontext, an die OFFENE POSITION gebunden, 1-h-Takt fuer offene Hebeltrades - erst wenn gemessen ist, dass Verkauf/Reduzieren tragen; eigene Positionsfrage mit Intraday-Fakten. (C) KERN/AKKUMULATION: vorerst KEINE Verkaufsaktionen; nachgelagert: bei laengerem Greed u. U. sinnvoll, Fear nicht. (7c) Ein Asset mit Spot- UND Hebelposition = zwei Positionen, zwei Verkaufssignale, keine Sammelmail. \u27a4 DIE DETAILPLANUNG FOLGT NACH DEM ROLLOUT (Nutzerauftrag: Doku lesen, Messdokumente beachten, testen und simulieren). \u27a4 NUTZERENTSCHEIDUNG 15.09.: VOR DIE AKKUMULATION GEZOGEN (vor die Schritte 25 bis 27). Grund: die Prioritaet des Nutzers vom 11.09. lautet ,1 Hebel 2 Spot 3 Akkumulation', und die Verkaufsseite betrifft Hebel und Spot; sie laeuft taeglich mit 15 bis 20 Empfehlungen ohne gemessene Guete, waehrend die gesperrte Akkumulation nichts ausloest und damit nicht schadet. Schritt 55 geht voraus (Ausstiegsmail nach Positionen). ➤ NACHTRAG 19.09.2026 (Befund 2.478-paket-v-nach-m1, Nutzerentscheidung): PAKET V IST HIERHER UEBERGEBEN. Erledigt und nicht zu wiederholen: V0 (Verkaufsmail als Information gekennzeichnet, 2.469), V1 zurueckgestellt (2.471 - eine Zelle erzeugt keine eigene Frage), V2 Basislinie gemessen (2.470 - nach den Ausstiegen STEIGT der Kurs), V2b Methodik (2.472 - Zielgroesse ist der Kontrafaktor behalten minus verkauft), V3a Haltefrage (2.473, 2.474 - nur `funding` traegt dort), V3b-1 Verkaufsregel (2.476 - traegt auf der ganzen Haltemenge, nicht auf der eigentlichen Haltefrage), B1/B2/B3 (2.477 - keine breitere Basis schliesst das Band). ⚠️ OFFEN UND HIER ZU MACHEN: V3b-2 (der Eingriff - Bewertung an Zeile und Mail oder Filter) UND V4, die systematische Ausstiegsmessung. V4 IST DER GROESSERE TEIL, denn heute ist EINER von VIER Verkaufsfaellen bewertet: Fall 1 (es gibt Besseres) teilweise, Fall 2 (Position zu gross), Fall 3 (Gewinnmitnahme) und Fall 4 (Absicherung) gar nicht - und Fall 3 und 4 sind die, die der Nutzer selbst genannt hat. V4 IN VIER TEILEN: (a) Zielgroesse je Verkaufsfall, dazu die Horizontfrage - die Literatur misst Allokation ueber EIN JAHR, wir haben H20 gemessen (2.472); (b) Literaturrecherche zu Ausstiegs-SIGNALEN, nicht zur Methodik - gesucht wurde bisher nur, WIE man einen Ausstieg bewertet; (c) Kandidatenliste je Fall: alle 22 registrierten sind auf der EINSTIEGSfrage registriert, fuer den Ausstieg sind genau drei je geprueft (`funding`, `turnover`, `oi_aenderung`), und es fehlen Drawdown vom Hoch, ATH-Abstand, Fear and Greed, Haltedauer, unrealisierter Gewinn und Positionsgroesse als Kandidaten ganz; (d) messen unter der Norm, je Fall getrennt. ⚠️ DATENLAGE DER FEHLENDEN, am 19.09. nachgesehen: Fear and Greed 3.149 Tage ab 2018 (messbar), Drawdown und ATH-Abstand aus den OHLC ableitbar (messbar), Zinsen 2.441 Tage (messbar) - dagegen BTC-Dominanz nur 70 Tage, VIX 58, Dollar-Index 48 (NICHT messbar). ⚠️ KEINE WARTEZEIT: Fall 3 und 4 werden HISTORISCH gemessen, nicht auf der wachsenden Signalstichprobe. Umfang geschaetzt 5 bis 6 Pakete",
    ...
    Schritt(68, "`turnover`: ZWEI GROESSEN IN EINEM NAMEN - EIGENSCHAFT ODER ZUSTAND?",
            "➤ ENTSTANDEN 21.09.2026 AUS SCHRITT 67, DURCH ZWEI NUTZERFRAGEN. Erst: *,pruefe ob dieser Wert bei Assets ohne neue Ausgabe und jenen die laufend verwaessern anwendbar ist`*. Dann, entscheidend: *,ist der Wert tatsaechlich Handelsvolumen je Umlaufmenge? Dann lag ich falsch mit statisch und wir reden von unterschiedlichen Hypothesen und auch Indikatoren`*. ⚠⚠⚠ DER BEFUND: `turnover` IST ZWEI GROESSEN IN EINEM NAMEN (2.506-zerlegung). In Logarithmen ist es `log Volumen - log Menge`, und die beiden streuen ueber die Zeit mit 0,8312 gegen 0,0212 - VERHAELTNIS 39 ZU 1. Der Nenner ist je Asset praktisch eine Konstante; der Querschnittsrang kodiert erheblich, WELCHES Asset es ist, nicht in welchem ZUSTAND. Das Registerblatt sagt aber ,viel AUFMERKSAMKEIT heisst eher ueberbewertet` - und Aufmerksamkeit ist ein Zustand. ⚠⚠ WARUM DAS SYSTEMRELEVANT IST: `turnover_fuenftel` traegt die GROESSTEN Stufen im System (+3,15 bis -2,40), geht in die Quote, und aus der Quote kommt ueber halbes Kelly der HEBELBETRAG. Ein Asset-Festwert sizet damit den Hebel - und REGEL 3 sagt ,beim HEBEL kein Asset-Rang`. ⚠ Regel 3 verbietet den Querschnittsvergleich NICHT (F-227), und in der MAIL ist die Eigenschaft erwuenscht. Es geht allein um den HEBEL. ➤ GEMESSEN (Zerlegung mit nachlaufendem 60-Tage-Schnitt, ohne Lookahead, feste Menge 10 Prozent, vier Saaten): LAGE traegt bei H2 und H3 (+0,0154 / +0,0242), EIGENSCHAFT ebenfalls (+0,0134 / +0,0134). BEIDE tragen - nach der Vorabfestlegung heisst das TRENNEN, NICHT MITTELN. Der Unterschied liegt in der DEUTLICHKEIT: bei H3 hat die Lage 0,0131 Abstand, die Eigenschaft 0,0005 - Faktor 26. ✔✔ DIE VERWAESSERUNGSFRAGE IST BEANTWORTET (2.506-verwaesserung): die Emissionsdynamik traegt als eigener Kandidat in KEINER EINZIGEN ZELLE - sechs Zellen ueber zwei Mengen. Der Mechanismus ist real (180 von 375 Symbolen wuchsen um ueber 5 Prozent, Median +22,3), ersaeuft aber im Rauschen des Zaehlers. Die Trennlinie ist NICHT das Emissionsmodell, sondern EIGENSCHAFT gegen ZUSTAND. ⚠ Und die Nutzerfalle wurde umgangen: gefragt wurde nicht ,ist Verwaesserung schlecht fuer den Kurs` (Markt), sondern ,traegt sie in UNSERER Anlage` (System). ⛔⛔ ABER NICHTS DAVON IST REGISTRIERUNGSREIF (2.506-randlage, und das ist das wichtigste Ergebnis): bei RUECKBLICK 90 statt 60 gibt es in ALLEN SECHS Zellen KEIN BEFUND - 18 Bloecke statt 20 - obwohl die Wirkungen praktisch gleich bleiben (+0,0242 gegen +0,0238). Die Blockzahlen liegen bei 18, 19 und 20; die Grenze ist 20. Ueber vier Bootstrap-Saaten kippt zwar kein Urteil, aber die Fragilitaet sitzt nicht im Zufall, sondern in der DECKUNG. ➤➤ ZU TUN, IN DIESER REIHENFOLGE: (1) MITLAEUFERTEST - traegt die LAGE noch, wenn die EIGENSCHAFT festgehalten wird? Beide stammen aus derselben Zahl; traegt die Lage nur, weil sie nebenbei dieselben Assets waehlt, ist sie kein eigener Beitrag (Prueflisten-Frage 1, Methodik 2.80). ✔✔ ERLEDIGT 21.09.2026, AUF ZWEI PFADEN (2.507-eigenstaendig): KEINER der beiden Teile ist ein Mitlaeufer des anderen. PFAD 1 geschichtet (`geschichtet` plus 40 Nullwelten statt EINER Negativkontrolle): die LAGE traegt innerhalb der Eigenschafts-Fuenftel bei H2, H3 und H5, und der Verlust gegenueber einer ZUFALLSschichtung betraegt nur 2 bis 10 Prozent. Die Eigenschaft traegt dort nirgends - aber auch nicht in ihrer eigenen Zufallskontrolle, war also auf jenem Pfad nie nachweisbar; der Test sagt ueber sie NICHTS. PFAD 2 Normpfad mit STETIGER Residualisierung (standardisierte Abweichung vom Fachmedian, damit `pruefe_auswahl` samt Trennschaerfe anwendbar bleibt): LAGE ohne Eigenschaft +0,0165/+0,0221 gegen LAGE ohne Zufall +0,0140/+0,0243 - Unterschied unter 10 Prozent, Richtung wechselnd. EIGENSCHAFT ohne Lage +0,0164/+0,0213/+0,0372 TRAEGT bei allen drei Horizonten, gegen EIGENSCHAFT ohne Zufall +0,0139/+0,0122/+0,0261. Dass das Herausrechnen der Lage die Eigenschaft STAERKT, ist kein Widerspruch - eine verrauschte Stoergroesse herauszunehmen erhoeht die Praezision. ✔ Beide Zufallskontrollen reproduzieren die unresidualisierte Messung; erst das macht die Tabelle lesbar. ➤ FOLGE NACH DER VORABFESTLEGUNG: BEIDE TRAGEN -> TRENNEN, NICHT MITTELN. ⚠⚠ UND WAS DARAUS FUER DEN HEBEL NICHT FOLGT: dass die Eigenschaft bleiben darf. Regel 3 verbietet den Asset-Rang beim Hebel nicht, WEIL er nichts beitraegt, sondern WEIL er ein Asset-Vorurteil ist - eine REGELFRAGE, keine Messfrage, und sie gehoert dem Nutzer. ⚠⚠⚠ DREI EIGENE WERKZEUGFEHLER AUF DEM WEG, alle durch die eigene Gegenpruefung gefunden (2.507-gleichstaende, 2.507-kontrolle): (a) die erste Residualisierung lief ueber RAENGE und erzeugte damit Gleichstaende, die es vorher nicht gab - nur 38 Prozent der Werte je Tag waren verschieden, und die Reihenfolgeprobe hat daraufhin ein URTEIL GEDREHT. Behoben durch eine stetige Konstruktion, Raster danach 100 Prozent und byteidentische Wirkungen. (b) Die erste Reihenfolgeprobe sass an der falschen Stelle - VOR der Residualisierung, wo die Werte noch stetig sind; ihr byteidentisches Ergebnis sah nach Stabilitaet aus und war ein Schalter, der nichts anfasst (dieselbe Klasse wie `--nullsaat`). (c) Die erste Mutation schichtete die Groesse nach SICH SELBST und brach nicht - was KEIN Werkzeugfehler war, sondern erwartbar; eine Mutation, die auch bei intaktem Werkzeug nicht bricht, prueft nichts. Ersetzt durch Zufallsschichten - und zwar auf BEIDEN Seiten, nachdem die erste Fassung sie nur der interessanten Seite gegeben hatte. ⛔ UNVERAENDERT: nichts davon ist registrierungsreif (2.506-randlage). Rueckblick 90 -> kein einziges Urteil; H5 hat bei den Lage-Armen 19 von 20 Bloecken; der Kontrollarm traegt nur bei 1 von 3 Horizonten. ⚠ Auf dem geschichteten Pfad gibt es KEINE Trennschaerfe: nur ein POSITIVER Befund ist dort deutbar. (2) DIE DECKUNG LOESEN, sonst bleibt jedes Urteil am Rand - der zirkulaere Verschub (2.286) braucht keine Bloecke und ist im Haus bereits als Methode beschlossen; er ist aber nur fuer die AKKUMULATION validiert, eine Uebertragung auf `bewegung_r` verlangt denselben Selbsttest gegen bekannte Wahrheit, den der Bootstrap bekommen hat (2.204, 2.485). (3) ERST DANN die Frage aus Schritt 67, welcher NENNER gilt - denn wenn die Groesse zwei Dinge misst, ist ,welcher Nenner` die ZWEITE Frage, nicht die erste. ✔✔✔ PUNKT 4 IST ENTSCHIEDEN - DURCH MESSUNG, GEGEN MEINEN EIGENEN VORSCHLAG (2.508-*). Auf die Nutzerfrage ,miss ob der Hebel besser wird oder schadet` wurde das LOGWACHSTUM gerechnet, mit den echten Betriebsfunktionen, 76.853 Anker, 2.401 Tage, drei Saaten, bei GLEICHEM Risikobudget. ERGEBNIS: die Hebelstufung TRAEGT (ALT gegen FLACH +0,000385 und gegen ZUFALL +0,000368, beide gegen den Nullpunkt belegt); sie zerfaellt in ENTSCHEIDUNG (+0,000270) und STUFUNG (+0,000115), beide belegt, die Entscheidung traegt doppelt so viel; und `turnover` WEGZULASSEN IST BELEGT SCHLECHTER (-0,000349, Band vollstaendig unter dem Nullpunkt). ⛔ MEIN SCHALTER-VORSCHLAG IST ZURUECKGEZOGEN - er waechst auf ZUFALLSNIVEAU (142,04 gegen ZUFALL 142,68 und ALT 167,15). ⚠ Die Klammer 0,5 bis 1,25 Prozent ist NICHT der Engpass. ⚠⚠ DER REGEL-3-KONFLIKT BLEIBT, jetzt als BENANNTER ZIELKONFLIKT: die Vorgabe verlangt etwas, das die Messung als wachstumsmindernd ausweist. Registrieren und beobachten, nicht stillschweigend aufloesen. ⚠⚠⚠ UND EIN EIGENER FEHLER GEHOERT DAZU (2.508-nullbezug-sizing): gegen die NULL geprueft war KEIN Vergleich belegt, gegen den NULLPUNKT sind es vier. Der Unterschied zweier Sizing-Regeln enthaelt einen Jensen-Anteil, der nur von der KONZENTRATION des Einsatzes kommt - und gegen die konzentrierte Regel geht. Ich hatte bereits ,die Hebelstufung ist nicht nachweislich besser als flaches Sizing` gemeldet; das war falsch. Die Hausregel vom 08.09. haette es verhindert - eine eigene Simulation erbt sie nicht automatisch. ➤ WAS OFFEN BLEIBT: Punkt 2 (zirkulaerer Verschub mit Selbsttest) ist weiterhin der Engpass - er wuerde die Untermacht der Randlage loesen, die alle Free-Float-Urteile traegt. ⚠⚠ R-R11 DURCHGEHEND: diese ganze Messreihe steht auf H2..H5, 365 Tagen und dem FREIEN Umlauf. Die Registrierung steht auf H20, 2.636 Tagen und der GESAMTAUSGABE. Sie kann die laufende Tabelle WEDER bestaetigen NOCH umstossen - sie schaerft die FRAGE. ⚠ NUTZERVORGABE 21.09.: *,wir muessen hier langsam und sorgsam vorgehen es geht um einen Beitrag der bereits Systemrelevant ist und von dem auch die Hebelfrage abhaengt`*",
            "Befunde 2.506-zerlegung, 2.506-verwaesserung, 2.506-randlage, 2.506-formzaehlung, 2.286 (zirkulaerer Verschub), 2.204/2.485 (Selbsttest), 2.505-*; Registerblatt `turnover`; CLAUDE.md Regel 3; F-227; Methodik 2.80; phase4_c_hypothese_turnover.py (Vorabfestlegung im Skriptkopf), phase4_c_mitlaeufer_asset_lage.py, phase4_c_statisch_gegen_verwaessernd.py",
            block="D-BEWERTUNG", umbau="neu"),
    Schritt(67, "DER `turnover`-NENNER: FREIER UMLAUF STATT GESAMTAUSGABE",
            "➤ ENTSTANDEN 20./21.09.2026 AUS PUNKT (7) VON SCHRITT 66 (2.497-turnover-luecke: bei 13 von 16 Hebelsignalen fehlt `turnover` - ⚠⚠ BERICHTIGT AM 21.09. AUF 15 VON 16, siehe 2.510-messliste-ohne-frische). Der Nutzerauftrag war ausdruecklich NICHT ,mit der Luecke umgehen`, sondern *,geh breit und detailliert auf Recherche wo wir zu brauchbaren daten kommen`* - und die Recherche hat etwas anderes gefunden als eine Luecke. ⚠⚠ DIE GROESSE WAR DIE FALSCHE, NICHT NUR DIE MENGE (2.500-splycur-ist-gesamtausgabe). Coin Metrics `SplyCur` ist die GESAMTAUSGABE auf dem Ledger, nicht der freie Umlauf; der Median-Unterschied zu CoinGecko betraegt 25 Prozent, bei XLM 67. Die passende Groesse heisst `SplyFF` und ist kostenpflichtig (403). ➤ GEFUNDEN: COINGECKO GIBT DEN FREIEN UMLAUF FREI - `market_chart` liefert Marktkapitalisierung und Preis, ihr Quotient IST die Umlaufmenge. 365 Tage taeglich, kein Schluessel. Abdeckung ✔ GEMESSEN 91 Prozent der im Fenster HANDELBAREN Werte - 376 von 415 (Nutzerziel war 80). ⚠ Die 99 Prozent davor waren die Zuordnungsquote aus der Machbarkeitspruefung, nicht die Abdeckung nach dem Abruf; gegen die ganze Messmenge V1 sind es 70 Prozent, aber dort stehen 122 Symbole, die im Fenster gar nicht handelbar waren. ⚠⚠ UND DIE MENGE IST NICHT UEBERLEBENSVERZERRT: geholt werden 350 TRADING PLUS die 59 im Fenster EINGESTELLTEN (Kapitel 120.3). Die 122 aelteren gehoeren nicht dazu - sie waren im Fenster gar nicht handelbar. Die 59 sind die im Fenster GESTORBENEN, und genau sie trennen eine saubere von einer ueberlebensverzerrten Menge (`grundgesamtheit-ist-keine-stellschraube`: die Fehlenden lagen im Median -0,6551 unter dem eigenen Schnitt). Sie haben keinen Binance-Ticker mehr und werden ueber den PREISVERLAUF zugeordnet (`--nachzug`): ein Kuerzel ist keine Kennung, eine Kurve ueber Monate praktisch schon. Zugeordnet wird nur, was EINDEUTIG ist - passen zwei Kandidaten, bleibt das Symbol offen. ➤➤ ZU TUN, IN DIESER REIHENFOLGE: (1) VOLLABRUF nach `data/umlaufmenge_cg.db` - laeuft, rund 70 Minuten bei der GEMESSENEN Grenze von fuenf Abrufen je Minute. (2) NACHZUG der Eingestellten und der Verworfenen ueber den Preisabgleich. (3) KALIBRIERUNG `phase4_c_kalibrierung_freefloat.py`, H2/H3/H5, Zielgroessen `bewegung_r` (Hauptzelle, darauf steht die registrierte Tabelle) und `barriere` (daran haengt der Hebel). ⚠⚠ DREI ARME, VORAB BENANNT, weil sich ZWEI Dinge geaendert haben: ALT (`SplyCur`, nur gemeinsame Symbole), NEU (Free Float, DIESELBEN Symbole), NEU-VOLL (Free Float, alle). ALT gegen NEU trennt die GROESSE, NEU gegen NEU-VOLL die MENGE. Ohne diese Trennung ist jede Differenz uninterpretierbar (R-R11). (4) ENTSCHEIDUNG des Nutzers, ob der Betriebsnenner wechselt. ✔✔ PUNKTE 1 BIS 3 SIND ERLEDIGT (21.09.2026): Vollabruf 71 Minuten und 321 ok; Nachzug 55 von 73 ueber den Preisverlauf, NULL mehrdeutig; Nennerpruefung sondert EIN Symbol aus (TON, ein gebrueckter Token mit 13.500 USD Marktkapitalisierung). Stand: 375 Symbole, 36 eingestellte Werte mit Reihe statt null. ⚠⚠ DIE KALIBRIERUNG HAT DAS ARGUMENT VERSCHOBEN (2.505-abdeckung-traegt): der GROESSENeffekt ist +0,0071 R, der MENGENeffekt +0,0258 - das Drei- bis Vierfache. Und die monotone Form der Stufentabelle kommt aus der MENGE, nicht aus der Groesse: NEU-GEM (neuer Nenner, dieselben 47 Symbole) ist an KEINEM Horizont monoton und sieht aus wie ALT. Das Argument fuer den Wechsel ist also die ABDECKUNG, nicht die Definition - 2.500 bleibt richtig, aber seine messbare Folge ist klein. ⚠⚠⚠ UND DER PREIS STEHT FEST (2.505-rangwirkung): ein Wechsel aendert 76,7 Prozent aller Fuenftel, 48 Prozent davon um zwei Stufen, und fast nur nach UNTEN (10.946 gegen 348). Die registrierte Stufentabelle ist auf den ALTEN Raengen kalibriert - sie auf die neuen anzuwenden waere die umgedeutete Zahl. EIN WECHSEL OHNE NEUKALIBRIERUNG IST AUSGESCHLOSSEN. ⚠⚠ UND DIE NEUKALIBRIERUNG IST IM 365-TAGE-FENSTER NICHT ZU HABEN (2.505-fenster-engpass): unter der Menge nach Datenlage traegt KEIN Arm, auch der ALTE nicht - und der lief ausdruecklich als MASSSTAB FUER DAS FENSTER mit. Ein TRAEGT gibt es nur auf fester Menge 50 Prozent (H2 +0,0073 und H3 +0,0131, Abstand 0,0009 und 0,0030 R, stabil ueber 5 Bootstrap- und 4 Nullwelt-Saaten). ➤➤ DARAUS DIE VORLAGE, vier Wege - und einer davon ist NICHT exklusiv: (A) NICHT WECHSELN, alles bleibt wie es ist; (B) WECHSELN UND NEU KALIBRIEREN - in einem Jahr nicht belegbar; (C) WECHSELN UND DIE STUFEN AUSSETZEN, `turnover` nur noch als Datenlage ohne Zuschlag; (D) PARALLEL WEITERSAMMELN - ein taeglicher Job, der die Free-Float-Reihe fortschreibt, bis das Fenster lang genug ist. D schliesst keinen der anderen aus und ist die einzige Quelle kuenftiger Aufloesung. ⛔ OFFEN UND UNABHAENGIG DAVON: die ALTE Quelle hat mindestens zwei Eintraege, die um Groessenordnungen von der neuen abweichen - KNC Faktor 18,6 und XVG Faktor 0,010 bei IDENTISCHER Mantisse (1,6522e10 gegen 1,6522e12). Ein Free Float kann nur KLEINER sein als die Gesamtausgabe; ein Verhaeltnis ueber 1 ist also ein Fehler in einer der beiden. XVG wechselt dadurch an 357 von 357 Tagen das Fuenftel. Welche Quelle recht hat, ist mit Hausmitteln NICHT entschieden: der dritte Zeuge (`price_cache.market_cap_usd`) deckt nur 7 Symbole und ist CoinGecko-nah, also fuer diese Frage kein Zeuge. ⚠⚠ WENN JA, ZIEHEN BEIDE SEITEN NACH - Betrieb UND Messbasis. Eine allein reicht nie, und die Wirkung wird GEMESSEN (wie viele Werte wechseln das Fuenftel), nicht geschaetzt. ⚠⚠ WAS DIESE MESSUNG NICHT KANN, vor dem Lauf gesagt: das Fenster ist EIN JAHR. `_block(H) = max(15, 3 x H)` - bei H2 und H3 bindet der Boden 15, alle drei Horizonte brauchen dieselben 300 Ankertage. H20 braeuchte 1.200 und ist ausgeschlossen. Faellt der ALT-Arm hier durch, ist das KEIN Widerruf der registrierten Tabelle, sondern die Aussage ,in einem Jahr nicht nachweisbar` - der ALT-Arm ist der MASSSTAB FUER DAS FENSTER, nicht der Angeklagte. ⚠️ NEBENBEFUND, der unabhaengig davon gilt: die Binance-Buendelpaare (`1000CAT`, `1MBABYDOGE`) handeln Vielfache, CoinGecko fuehrt den Einzeltoken. Ohne Faktor stuende die Menge um bis zu 10^6 zu hoch und das Symbol am untersten Rand des Rangs - ohne dass am Markt etwas passiert waere. Der Faktor wird aus dem NAMEN abgeleitet, nicht aufgezaehlt (`1INCH` heisst so und ist kein Buendel). ✔✔✔ ZWEI PUNKTE SIND ERLEDIGT (21.09.2026, nachdem der Nutzer nachfragte *,irgendwas hast du vergessen`* - und beides stimmte). ERSTENS DIE NENNERSPERRE (2.509-nennersperre): XVG und KNC standen im LAUFENDEN Rang nachweislich falsch, beide frisch und taeglich wirksam; XVG bekam durch eine 100fach zu hohe Menge dauerhaft +3,15 Punkte, KNC dauerhaft -2,40 - die groessten Stufen im System, aus einem Datenfehler. Gesperrt in `marktrang.NENNER_WIDERLEGT`, NACH dem Zusammenfuehren beider Quellen und nicht still. ⚠ Vor dem Bau wurde nach einer SCHWELLE gesucht - es gibt keine, die beide ohne Kollateral trifft (Decke 1,0: keinen; 1. Perzentil: keinen, XVG liegt bei 3 Prozent; 99. Perzentil: nur KNC). Die Liste ist deshalb ein MESSERGEBNIS mit Erzeuger, kein Katalog - Methodik 2.509 haelt den dritten, zulaessigen Fall fest. ✔ Preis gemessen: 3,26 Prozent Fuenftelwechsel bei den uebrigen, KEINES um zwei Stufen (Hausgrenze 6,5). ✔ Am SEITENEFFEKT nachgewiesen, Paket `Nennersperre`, 6 Pruefungen. ZWEITENS DER TAGESMODUS (2.509-kein-schreiber): `data/umlaufmenge_cg.db` hatte KEINEN Schreiber und waere still veraltet. Verloren gegangen waeren nicht die Reihen - CoinGecko gibt 365 Tage rueckwirkend - sondern die SYMBOLE, DIE IN DER ZWISCHENZEIT EINGESTELLT WERDEN, also genau die, fuer die der Nachzug lief. Schwund rund 15 Prozent im Jahr, und er trifft den Boden der Verteilung. `--taeglich` holt 373 von 375 Symbolen in 0,8 Minuten mit VIER Abrufen statt 332. ⚠ Vor dem Bau geprueft, ob `/coins/markets` dieselbe Groesse liefert wie `Marktkapitalisierung / Preis`: Median-Abweichung 0,000 Prozent an 119 Symbolen. ⛔ OFFEN BLEIBT DER JOB-EINTRAG - das Skript laeuft weiter von Hand, ein Schedulereintrag am Notebook ist eine Betriebsentscheidung. ⛔ UND OFFEN BLEIBT DER BUENDELFAKTOR IM BETRIEB: er ist im Abruf eingebaut, aber `marktrang` und `messe_kandidaten_als_regel` haben ihn NICHT - noetig erst, wenn der Nenner wechselt, und der wechselt nach 2.508 vorerst NICHT. ✔✔ BENENNUNG GEZOGEN (21.09., 2.512): die beiden Groessen heissen ab jetzt `umschlag_gesamt` (Volumen durch GESAMTAUSGABE, LIVE) und `umschlag_frei` (Volumen durch FREIEN UMLAUF, nicht im Betrieb). Kanonische Tabelle `marktrang.UMSCHLAG_GROESSEN`, Zuordnung abgeleitet ueber `umschlag_name`, 15 Pruefungen im Paket `Verfuegbarkeit`, 5 von 5 Mutationen. ⛔ UND DAMIT IST DER STAND DIESES SCHRITTS PRAEZISE ZU SAGEN: `umschlag_frei` ist NICHT FERTIG VERMESSEN. Geprueft sind Abruf (375 Symbole, 91 Prozent der handelbaren), Nennerfehler, Kalibrierung auf H2/H3/H5 ueber beide Zielgroessen und die Rangwirkung. ES FEHLEN: (a) die Messung auf der SELEKTIERTEN Menge - das Kandidatenregister verlangt sie ausdruecklich fuer jede Tabellenaenderung; (b) eine Stufentabelle; (c) H20, der Horizont der registrierten Anwendung. ⚠⚠ Das einzige TRAEGT steht auf FESTER Menge 50 Prozent mit Abstaenden von 0,0009 und 0,0030 R; unter der Menge nach Datenlage traegt es nicht, und auf `barriere` traegt kein Arm. \u26a0\u26a0 UND ER GEHOERT IN DEN BETRIEB, BEVOR DER NENNER WECHSELT - DAS IST PUNKT 4 DIESES SCHRITTS. Nachgemessen 21.09.: `splycur` fuehrt 66 Symbole und darunter KEIN Buendelpaar, die Messmenge V1 aber vier (1000CAT, 1000CHEEMS, 1000SATS, 1MBABYDOGE). Der Betrieb ist heute also nur deshalb nicht betroffen, WEIL IHM DIE DATEN FEHLEN - `marktrang.turnover_werte` ueberspringt jedes Symbol ohne Menge. Die neue Quelle deckt ⚠ 91 Prozent der im Fenster handelbaren (376 von 415; hier stand bis zum 21.09. 99 Prozent, die Zuordnungsquote) und bringt die vier mit; ohne Faktor in `marktrang` UND `messe_kandidaten_als_regel` wanderte der Fehler mit der Loesung ein.",
            "Befunde 2.497-turnover-luecke, 2.500-splycur-ist-gesamtausgabe, 2.500-ergaenzung-ausgeschlossen, 2.410, 2.416, 2.417, 2.487-grundgesamtheit; Nutzerauftrag 20.09.2026 (Recherche, Vollabruf, ,80 prozent abdeckung waere schon gut'); hole_umlaufmenge_cg.py, phase4_c_kalibrierung_freefloat.py, phase4_c_machbarkeit_umlaufmenge.py; Kapitel 120.3",
            block="D-BEWERTUNG", umbau="neu"),
    Schritt(66, "PHASE 4 - DIE VIER OFFENEN BEFUNDE AUS DEM HEBEL-TAG",
            ...
            "Handlungsbedarf. (8) 2.498-betrag-bei-luecke - der "
            "Abschlag ist GERECHNET: rund 80 Prozent des Betrags am "
            "heutigen Arbeitspunkt, und er haengt am Abstand zum "
            "Breakeven (+0,5 Punkte -> 44 %, +2,0 -> 96 %). Einbau "
            "waere eine Aenderung an `betraege.hebelrechnung`, also "
            "am Betrieb. "
            "(7) 2.497-turnover-luecke - bei 13 von "
            "16 Hebelsignalen fehlt `turnover`; die Luecke zaehlt 0,0 "
            "und wirkt EINSEITIG: bei 2 von 5 Raengen entstuende gar "
            "kein Hebel, sonst ein hoeherer. Zu entscheiden ist, ob "
            "ein Signal mit fehlendem tragenden Beitrag ueberhaupt "
            "ein Hebelgeschaeft werden darf. ⚠⚠ NICHT MEHR "
            "HIER ZU ENTSCHEIDEN, SONDERN NACH SCHRITT 67. Die "
            "Recherche hat die Luecke nicht verwaltet, sondern ihre "
            "Ursache gefunden: die alte Quelle deckt 61 Symbole, die "
            "neue ⚠ 91 PROZENT der im Fenster handelbaren (376 von "
            "415) - und das ist eine KORREKTUR: hier stand bis zum "
            "Audit am 21.09. die Zahl 99 Prozent. Die war die "
            "ZUORDNUNGSQUOTE aus der Machbarkeitspruefung (wie viele "
            "Symbole eine coin_id bekommen), nicht die Abdeckung nach "
            "dem Abruf. In Schritt 67 wurde sie berichtigt, hier blieb "
            "sie stehen. ⚠⚠ UND SIE IST NICHT DIE ZAHL, DIE FUER "
            "DEN HEBEL ZAEHLT: dort sind es ⚠⚠ 1 VON 16 "
            "Signalen mit `turnover`-Wert, also 6 PROZENT "
            "(2.510-messliste-ohne-frische). ZWEITE KORREKTUR AM "
            "SELBEN TAG: hier stand zuerst 99, dann 19 Prozent. Die "
            "19 stammten aus 2.497 und waren ihrerseits falsch - das "
            "Werkzeug fragte die SYMBOLLISTE der Messdatei ab, die "
            "die Frischegrenze nicht kennt. BNB steht darin, sein "
            "letzter Coin-Metrics-Wert ist vom 22.04.2019. Der "
            "Betrieb verwirft ihn, das Werkzeug zaehlte ihn mit. "
            "DREI verschiedene Abdeckungen - 6 Prozent im HEBEL, 12 "
            "Prozent der alten Quelle ueber die MESSMENGE, 91 Prozent "
            "der neuen Quelle - und sie gehoeren auseinandergehalten. "
            "Wer jetzt "
            "eine Regel fuer den Umgang mit der Luecke baut, baut sie "
            "fuer einen Zustand, der gleich nicht mehr gilt. "
            "(6) 2.496-hebel-roh-fehlt - `hebel_roh` "
            "und vier Flags werden gerechnet und nicht geschrieben; die "
            "reale Hebelverteilung ist damit nicht auswertbar. "
            "Schemaaenderung am Betrieb, Nutzerentscheidung. "
            "(5) 2.495-spot-hebel-verhaeltnis - NUR "
