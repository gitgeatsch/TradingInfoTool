...
REIHENFOLGE = (
    ...
    Schritt(66, "PHASE 4 - DIE VIER OFFENEN BEFUNDE AUS DEM HEBEL-TAG",
            ...
            "DEN HEBEL ZAEHLT: dort sind es 3 von 16 Signalen mit "
            "`turnover`-Wert, also 19 PROZENT (2.497-turnover-luecke). "
            "DREI verschiedene Abdeckungen - 19 Prozent im HEBEL, 12 "
