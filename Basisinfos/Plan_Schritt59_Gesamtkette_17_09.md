...
| **V3b-2** | Potential/Schwelle/Deckel für den Ausstieg; der `return` nach `_sende_ausstieg` fällt | V3b-1 ✔ | ⚠️ **ENTSCHEIDUNG OFFEN:** eine Schwelle aus V3b-1 ist auf der Teilmenge **nicht belegt**. Entweder auf der **ganzen Haltemenge** bauen und den Vorbehalt mitführen, oder die **Messbasis verbreitern**. Ein Eingriff ohne diese Entscheidung wäre ein Vorgriff |
