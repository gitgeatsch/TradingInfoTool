...
| 0.9 | **ETF-Knopf-Lücke schließen** (2.456-etf-knopf): Sperre über `assetklassen.gruppe(asset)` statt Watchlist-Feld | Bau klein, D-BETRIEB |
| 0.10 | **Abgrenzung Multiasset** (2.456-abgrenzung, N11): Gruppe beim Schreiben in `signals` festhalten; zusammen mit 0.7 die Kennzeichnung in `signal_mail.baue_mail` (Betreff und Kopf, Merker `vermessen`) und in der Verkaufs-Sammelmail | Bau klein/mittel, D-BETRIEB |
