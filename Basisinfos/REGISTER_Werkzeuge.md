...
*Erzeugt aus `bestand.py` durch **Scan**, nicht gepflegt — 342 Eintraege von Hand zu fuehren waere dieselbe Falle noch einmal.*
...
|---|---|---|---|
| **NORM** | 43 | 13 % | ruft `messnorm` - der aktuelle Stand, Trennschaerfe Pflicht |
...
> ⚠️ **183 von 342 Werkzeugen (54 %) sind Altbestand.** Ein Befund aus dieser Gruppe gilt nur mit Vorbehalt — er hat weder Tagesklammer noch Trennschaerfe.
...
## NORM (43)
    ...
    messe_hebel_neudimension.py, messe_inverse_achse.py, messe_nachzieher.py, messe_q_beide_seiten.py
    messe_regime_rollierend.py, messe_reverse_scharfe_anstiege.py, messe_selektion.py, messe_sperre_wirkung.py
    messe_traegt_er.py, messe_trailing_und_betrieb.py, messnorm_auswahl.py, messnorm_rand.py
