...
*Erzeugt aus `bestand.py` durch **Scan**, nicht gepflegt — 339 Eintraege von Hand zu fuehren waere dieselbe Falle noch einmal.*
...
|---|---|---|---|
| **NORM** | 40 | 12 % | ruft `messnorm` - der aktuelle Stand, Trennschaerfe Pflicht |
...
> ⚠️ **183 von 339 Werkzeugen (54 %) sind Altbestand.** Ein Befund aus dieser Gruppe gilt nur mit Vorbehalt — er hat weder Tagesklammer noch Trennschaerfe.
...
## NORM (40)
    ...
    messe_funding_je_geometrie.py, messe_haltedauer.py, messe_hebel_geometrie_neutral.py, messe_nachzieher.py
