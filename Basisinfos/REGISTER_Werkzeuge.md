...
*Erzeugt aus `bestand.py` durch **Scan**, nicht gepflegt — 338 Eintraege von Hand zu fuehren waere dieselbe Falle noch einmal.*
...
|---|---|---|---|
| **NORM** | 39 | 12 % | ruft `messnorm` - der aktuelle Stand, Trennschaerfe Pflicht |
...
> ⚠️ **183 von 338 Werkzeugen (54 %) sind Altbestand.** Ein Befund aus dieser Gruppe gilt nur mit Vorbehalt — er hat weder Tagesklammer noch Trennschaerfe.
...
## NORM (39)
    ...
    messe_bewertung_kalibrierung.py, messe_drift_herkunft.py, messe_ema_laenge.py, messe_funding_je_geometrie.py
