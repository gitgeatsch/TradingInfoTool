...
*Erzeugt aus `bestand.py` durch **Scan**, nicht gepflegt — 343 Eintraege von Hand zu fuehren waere dieselbe Falle noch einmal.*
...
|---|---|---|---|
| **NORM** | 44 | 13 % | ruft `messnorm` - der aktuelle Stand, Trennschaerfe Pflicht |
...
| **ALTBESTAND** | 183 | 53 % | weder Norm noch Tagesklammer - Befunde nur mit Vorbehalt |

> ⚠️ **183 von 343 Werkzeugen (53 %) sind Altbestand.** Ein Befund aus dieser Gruppe gilt nur mit Vorbehalt — er hat weder Tagesklammer noch Trennschaerfe.
...
## NORM (44)
    ...
    messe_endetest_out_of_sample.py, messe_funding_je_geometrie.py, messe_geometrie_invers.py, messe_haltedauer.py
    messe_hebel_geometrie_neutral.py, messe_hebel_neudimension.py, messe_inverse_achse.py, messe_nachzieher.py
    messe_q_beide_seiten.py, messe_regime_rollierend.py, messe_reverse_scharfe_anstiege.py, messe_selektion.py
    messe_sperre_wirkung.py, messe_traegt_er.py, messe_trailing_und_betrieb.py, messnorm_auswahl.py
