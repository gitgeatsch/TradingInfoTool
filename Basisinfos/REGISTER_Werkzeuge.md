...
*Erzeugt aus `bestand.py` durch **Scan**, nicht gepflegt — 313 Eintraege von Hand zu fuehren waere dieselbe Falle noch einmal.*
...
| **ALTBESTAND** | 180 | 58 % | weder Norm noch Tagesklammer - Befunde nur mit Vorbehalt |

> ⚠️ **180 von 313 Werkzeugen (58 %) sind Altbestand.** Ein Befund aus dieser Gruppe gilt nur mit Vorbehalt — er hat weder Tagesklammer noch Trennschaerfe.
...
## ALTBESTAND (180)
    ...
    pruefe_rollout_14_09.py, pruefe_s6a_rollen.py, pruefe_short_ursache.py, pruefe_sperrquote_wirkung.py
