...
*Erzeugt aus `bestand.py` durch **Scan**, nicht gepflegt — 337 Eintraege von Hand zu fuehren waere dieselbe Falle noch einmal.*
...
|---|---|---|---|
| **NORM** | 38 | 11 % | ruft `messnorm` - der aktuelle Stand, Trennschaerfe Pflicht |
...
> ⚠️ **183 von 337 Werkzeugen (54 %) sind Altbestand.** Ein Befund aus dieser Gruppe gilt nur mit Vorbehalt — er hat weder Tagesklammer noch Trennschaerfe.
...
## NORM (38)
    ...
    messe_a_faktoren.py, messe_alle_kandidaten.py, messe_betrieb_umlegung.py, messe_bewertung_kalibrierung.py
    messe_drift_herkunft.py, messe_ema_laenge.py, messe_funding_je_geometrie.py, messe_haltedauer.py
    messe_hebel_geometrie_neutral.py, messe_nachzieher.py, messe_q_beide_seiten.py, messe_regime_rollierend.py
