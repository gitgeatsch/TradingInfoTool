...
| **BLOCK** | 83 | 27 % | eigener Blockbootstrap, ausserhalb der Norm |
...
## BLOCK (83)
    ...
    messe_auswahl_kriterium.py, messe_beitrag_auf_auswahl.py, messe_datenqualitaet.py, messe_drift_wiederholung.py
    messe_einordnung_wirkung.py, messe_form_und_nullpunktkurve.py, messe_fremdgroesse.py, messe_fuenftel_mit_tagesklammer.py
    messe_g_trefferbilanz.py, messe_h_als_filter.py, messe_h_als_marktmerkmal.py, messe_h_anteil_vorlauf.py
    messe_h_je_asset.py, messe_h_produktionsgeometrie.py, messe_halte_kriterium.py, messe_horizont_aus_stop.py
    ...
    messe_planungshorizont.py, messe_querschnitt_umkehr.py, messe_rand_je_schicht.py, messe_rangschichtung.py
    messe_rangverfall.py, messe_rascher_anstieg.py, messe_regimephasen_llm.py, messe_sentiment_je_horizont.py
    messe_short_und_einbruch.py, messe_stop_abstand_baender.py, messe_stopquelle.py, messe_stopweite_historisch.py
