...
*Erzeugt aus `bestand.py` durch **Scan**, nicht gepflegt — 335 Eintraege von Hand zu fuehren waere dieselbe Falle noch einmal.*
...
|---|---|---|---|
| **NORM** | 36 | 11 % | ruft `messnorm` - der aktuelle Stand, Trennschaerfe Pflicht |
...
> ⚠️ **183 von 335 Werkzeugen (55 %) sind Altbestand.** Ein Befund aus dieser Gruppe gilt nur mit Vorbehalt — er hat weder Tagesklammer noch Trennschaerfe.
...
## NORM (36)
    ...
    messe_selektion.py, messe_sperre_wirkung.py, messe_traegt_er.py, messnorm_auswahl.py
