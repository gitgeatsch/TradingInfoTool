...
*Erzeugt aus `bestand.py` durch **Scan**, nicht gepflegt — 336 Eintraege von Hand zu fuehren waere dieselbe Falle noch einmal.*
...
|---|---|---|---|
| **NORM** | 37 | 11 % | ruft `messnorm` - der aktuelle Stand, Trennschaerfe Pflicht |
...
> ⚠️ **183 von 336 Werkzeugen (54 %) sind Altbestand.** Ein Befund aus dieser Gruppe gilt nur mit Vorbehalt — er hat weder Tagesklammer noch Trennschaerfe.
...
## NORM (37)
    ...
    messe_a_faktoren.py, messe_alle_kandidaten.py, messe_bewertung_kalibrierung.py, messe_drift_herkunft.py
    messe_ema_laenge.py, messe_funding_je_geometrie.py, messe_haltedauer.py, messe_hebel_geometrie_neutral.py
