...
*Erzeugt aus `bestand.py` durch **Scan**, nicht gepflegt — 334 Eintraege von Hand zu fuehren waere dieselbe Falle noch einmal.*
...
|---|---|---|---|
| **NORM** | 35 | 10 % | ruft `messnorm` - der aktuelle Stand, Trennschaerfe Pflicht |
...
> ⚠️ **183 von 334 Werkzeugen (55 %) sind Altbestand.** Ein Befund aus dieser Gruppe gilt nur mit Vorbehalt — er hat weder Tagesklammer noch Trennschaerfe.
...
## NORM (35)
    ...
    messe_sperre_wirkung.py, messe_traegt_er.py, messnorm_auswahl.py, messnorm_rand.py
