...
| **ALTBESTAND** | 176 | 58 % | weder Norm noch Tagesklammer - Befunde nur mit Vorbehalt |

> ⚠️ **176 von 306 Werkzeugen (58 %) sind Altbestand.** Ein Befund aus dieser Gruppe gilt nur mit Vorbehalt — er hat weder Tagesklammer noch Trennschaerfe.
...
## ALTBESTAND (176)
    ...
    pruefe_rollenkette.py, pruefe_s6a_rollen.py, pruefe_short_ursache.py, pruefe_sperrquote_wirkung.py
