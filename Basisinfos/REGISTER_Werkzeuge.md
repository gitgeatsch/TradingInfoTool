...
*Erzeugt aus `bestand.py` durch **Scan**, nicht gepflegt — 341 Eintraege von Hand zu fuehren waere dieselbe Falle noch einmal.*
...
|---|---|---|---|
| **NORM** | 42 | 12 % | ruft `messnorm` - der aktuelle Stand, Trennschaerfe Pflicht |
...
> ⚠️ **183 von 341 Werkzeugen (54 %) sind Altbestand.** Ein Befund aus dieser Gruppe gilt nur mit Vorbehalt — er hat weder Tagesklammer noch Trennschaerfe.
...
## NORM (42)
    ...
    messe_endetest_out_of_sample.py, messe_funding_je_geometrie.py, messe_haltedauer.py, messe_hebel_geometrie_neutral.py
    messe_hebel_neudimension.py, messe_nachzieher.py, messe_q_beide_seiten.py, messe_regime_rollierend.py
    messe_reverse_scharfe_anstiege.py, messe_selektion.py, messe_sperre_wirkung.py, messe_traegt_er.py
    messe_trailing_und_betrieb.py, messnorm_auswahl.py, messnorm_rand.py, pruefe_audit_06_07_09.py
