...
Muster (Stand 15.09.2026, 55 Dateien):
...
## A · SCHREIBEN ODER HOLEN VON BITPANDA — werden ersetzt oder umgestellt (14)
...
| `importer/bitpanda_bestand.py` | **Sync:** Modulebene, abgleich_neu, bestandsabgleich<br>**Bestand schreibt:** _verschwundene, abgleich_neu<br>**Bestand liest:** Modulebene, _verschwundene, abgleich_neu<br>**Cash:** abgleich_neu<br>**Stempel:** abgleich_neu<br>**hebel_positions:** Modulebene | NEU 16.09. (Stufe 1.2): Bestandsabgleich ueber die neue Schnittstelle - Salden je Wallet aus `asset_balance_after` (Tabelle `bitpanda_wallet_saldo`), Gegenprobe gegen `/portfolio`, Zuordnung ueber ISIN/Symbol/Alias, Signal-Bestaetigung nur bei echtem Verkauf (E10), verschwundene Positionen (E11), Meldungen mit Name/Wert/Status/Aktion (E13); Waehler `bestandsabgleich` (E12) | Cash bleibt bis 1.3 beim alten `sync_fiat_cash_from_bitpanda`; Stufe 3 Hebel; alter Abgleich erst nach bestaetigtem Betrieb entfernen |
