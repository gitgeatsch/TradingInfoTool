<!-- STAND: 2026-09-06 · VOR dem Messstandard vom 2026-09-09 -->

> ⚠️⚠️ **DIESES DOKUMENT SAH DEN UMBAU NICHT.** Zuletzt geaendert
> **2026-09-06**; der Messstandard gilt ab **2026-09-09**.
>
...
> `REGISTER_Befunde.md`.
>
> ⚠️⚠️ **25 Messwerte** in diesem Dokument — hier ist die
...
|----|-------|----------------|--------|
| RM-1 | Risiko pro Trade — wie viel des Portfolios darf bis zum Stop-Loss maximal verloren gehen | **2 %** | AKTIV, seit 2026-07-10 hart durchgesetzt: schlägt die KI eine größere Position vor, wird sie automatisch auf diesen Wert gekürzt. **Nachtrag 04.08. (#606, entschieden):** RM-1 bleibt die harte **Obergrenze**, bekommt aber eine **empfohlene Größe** danebengestellt — fractional Kelly (quarter) auf das CRV. Beide Zahlen werden gerechnet, gespeichert und gemeinsam angezeigt ("Empfohlen nach CRV: X — RM-1 erlaubt bis Y"). Grundlage: gemessen am 04.08., gepaart +0,055 R je Signal, mit Konfidenz-Kopplung +0,073 R. **Kelly kann RM-1 nie überschreiten.** **KEIN Volatilitäts-Divisor** — Volatilität steckt über RM-5 bereits in RM-1, eine zweite Division war in der Messung signifikant SCHÄDLICH (siehe Regler-Matrix, RM-5 → RM-1) |
...
Chronologie aller Änderungen, Untersuchungen und bewusst verworfenen Optionen
(146 Einträge, 2026-07-17 bis heute) steht in
...
eingearbeitet. Bei einer Frage nach dem aktuellen Stand einer Regel deshalb
immer beide Dokumente prüfen.
