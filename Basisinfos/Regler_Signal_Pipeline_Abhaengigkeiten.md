<!-- STAND: 2026-08-16 · VOR dem Messstandard vom 2026-09-09 -->

> ⚠️ **DIESES DOKUMENT SAH DEN UMBAU NICHT.** Zuletzt geaendert
> **2026-08-16**; der Messstandard gilt ab **2026-09-09**.
>
...
| **Kelly-Empfehlung → RM-1** (Stage 1, ab #606) | — | — | **Entschieden 04.08., Umsetzung offen.** Neben der RM-1-Obergrenze wird eine EMPFOHLENE Größe ausgewiesen: fractional Kelly (quarter) auf das CRV, `f* = (p·b − q)/b` mit b = CRV. Beide Zahlen werden gespeichert und gemeinsam angezeigt. **Kelly kann RM-1 nie überschreiten** — die Obergrenze bleibt hart. **Warum als sichtbare Empfehlung und nicht als Deckel:** der gemessene Vorteil (+0,055 R) entsteht nur, wenn die Größen tatsächlich variieren. Der Nutzer setzt den Einsatz bisher selbst (100–500); ein weiterer Deckel wäre folgenlos, wie die vier bereits geprüften Positionsgrößen-Deckel (siehe `project_positionsgroessen_praxis_entkopplung`). **Vor jeder Änderung an dieser Stelle die Zeile darüber lesen** — wer hier zusätzlich Volatilität einrechnet, zählt sie doppelt |
