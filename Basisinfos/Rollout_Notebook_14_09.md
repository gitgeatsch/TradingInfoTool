...
| *(nächster Commit)* | **Kennzeichnung nicht vermessener Bereiche** | Kaufmails für Aktien, Rohstoffe, Themen-ETF und Absicherung tragen im Betreff `· Themen-ETF, nicht vermessen` und als erste Zeile `⚠️ NICHT VERMESSEN – …`; Verkaufs-Sammelmails dieser Bereiche nennen den Bereich; Krypto-Mails unverändert; jede neue Signalzeile speichert ihre Gruppe | 2.456-abgrenzung | ⏳ Pull ausstehend (K14) |
