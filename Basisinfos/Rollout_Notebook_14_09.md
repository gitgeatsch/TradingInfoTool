...
| *(nächster Commit)* | **Messskripte nur lesend, Messprotokoll** | Acht Mess- und Prüfskripte öffnen die Datenbank nur noch lesend; das Messprotokoll nennt 40 statt 5 Nullziehungen. **Kein Laufzeitcode der App** – `git pull` genügt, **kein Neustart nötig**; am NB nichts zu sehen. Optional: CLAUDE.md-Zeile „Nullpunkt“ (lokale Datei) per USB angleichen | 2.457-nurlesend, 2.457-protokoll | ⏳ Pull |
