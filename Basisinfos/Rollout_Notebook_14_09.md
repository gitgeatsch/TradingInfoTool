...
| *(nächster Commit)* | **Die Kette schreibt ihre Spur je Zelle** | Neue Tabelle `zellen_lauf`: je geprüftem Wert eine Zeile mit erreichter Stufe, Ergebnis, Grund im Klartext und Verweis auf die Signalzeile – rund 200 Zeilen am Tag. **Nichts davon entscheidet etwas.** `git pull` **und App neu starten** (die Tabelle entsteht beim Start), danach Export | 2.458-protokoll-2 | ⏳ Pull + Neustart (K18) |
