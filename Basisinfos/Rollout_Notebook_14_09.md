...
| *(nächster Commit)* | **Die Kette schreibt mehr mit** | Jede Signalzeile trägt jetzt den **Kurs zum Empfehlungszeitpunkt**, das **Potential mit Schwelle** (bisher nur bei abgelehnten Fällen) und die neue Spalte **Phase** (Einstieg / Führung / Ausstieg / Akkumulation). **Nichts davon entscheidet etwas** – es wird nur erfasst. `git pull` **und App neu starten**, danach Export | 2.458-protokoll-1 | ⏳ Pull + Neustart (K17) |
