...
**Stand:** 26.09.2026 (spaeter Abend) · ⛔⛔⛔ DIE BEWERTUNG VOM VORMITTAG IST WIDERLEGT UND DIE ACHSE UMGEDREHT. 2.624: die Nullwelt war GEPOOLT statt tagestreu - mit dem Standardprueftstand traegt KEINE der sechs Schwellen (2.608 auf 3.181.434 Ankern reproduziert und gefallen). 2.625: die Achse ist INVERTIERT - Assets weit UNTER ihrem EMA liefern +1,31 Prozent relativ zum Tag, weit darueber -0,94. ⭐⭐⭐ UND DIE GEGENRICHTUNG TRAEGT: 2.626 gibt 12 von 12 Fenstern out-of-sample, 115 von 115 Symbolen, +1,33 Prozent absolut, alle Horizonte von 6 bis 72 h - je kuerzer desto schneller. 2.628: Geometrie H24 / Stop 1,00 ATR / Trailing 1,5 / 0,5 mit +1,5883 Prozent je Trade. 2.627: die Hebelhoehe 2-5x folgt aus RM-11 und der Verlustserie, NICHT aus Kelly - die Statistik liefert keine Obergrenze, weil die Stop-Annahme die Verlustseite abschneidet. 2.629: die Stopquoten-Grenze kommt aus den Kosten, das Netto-Optimum liegt bei genau Stop 1,00. ⛔ NICHTS DAVON IST VERDRAHTET. — vormittags galt: ⭐⭐⭐ DIE BEWERTUNG IST EINE ABSOLUTE SCHWELLE IN ATR, KEIN PERZENTIL (2.608) - der Nutzer hat den Perzentil-Ansatz gekippt (*das System muss auch bei nur EINEM Asset funktionieren*), und die Korrektur traegt: auf den 15 liquiden Watchlist-Symbolen E[R] +0,2079 bei Schwelle 1,0 ATR, 2,0 Signale/Tag, signifikant, monoton dosierbar von 0,3 bis 1,2 ATR. ⛔⛔ ZWEI SPERREN VOR DER HEBELHOEHE: der MEDIAN ist negativ (-0,1885), die Verteilung schief - die Hoehe darf NICHT aus E[R] allein folgen (2.609); und die Abdeckung liegt bei 15 von 43, wobei die Luecke BESCHAFFUNG ist, keine Datenlage, und drei der Fehlenden OFFENE POSITIONEN sind (2.611). ✔ Die Bewertung braucht 10 Tage Historie, nicht Jahre - das ist aber ein WATCHLIST-Thema, kein Hebelthema (2.610, Nutzereinordnung). ⛔⛔⛔ UND DER NUTZER HAT DIE URSACHE BENANNT: es gibt VIER SYMBOLWELTEN ohne Bruecke - Bitpanda (blanke Ticker), CoinGecko (IDs wie `aster-2`, 74 Prozent zugeordnet, ueber drei Tabellen verstreut), Binance Spot und Binance Futures (GAR KEINE Zuordnung, nur Namensgleichheit). Stundenkurse haben nur 28 von 57 relevanten Symbolen (49 Prozent). Ein Stammsatz je Asset ist die Voraussetzung fuer jede Neuaufnahme - 2.612, nicht behoben, nur gemessen. — vorher (26.09. mittags): ⭐⭐ HEBEL-ARM NEU GEBAUT, erster positiver Erwartungswert: Selektion der Spitze (1 % nach `ema_abstand_atr`, EMA 48 h) plus Trailing 1,0 ATR ergibt E[R] +0,1155 - signifikant (6x Tagesfehler), in ALLEN funf Jahren belegt, 2026 am staerksten. Befunde 2.597-2.607. ⚠ Betrieblich offen: andere Grundgesamtheit, Gebuehren, Ausfuehrbarkeit, nicht verdrahtet. — vorher (24.09.): Hebelumbau abgesagt, B0 zeigte, die Wirkung kam aus dem gesperrten Fuenftel (2.57
