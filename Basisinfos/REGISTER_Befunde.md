...
**2.380-ohne-stop** — ⚠️ ZUR ENTSCHEIDUNG: POSITION OHNE BEKANNTEN STOP im Aggregat-Deckel. Variante A (ganzes Eigenkapital) vom Nutzer ABGELEHNT: *,eine Position blockiert alles, das passt nicht zu unserem Vorgehen - initial haben wir angedacht, dass zumindest drei Hebelpositionen offen sein koennen'*. Vorgelegt Variante B: angenommener Stop 11,7 %% (Median der Systemstops, 2.378-gegenpruefung), hoechstens das Eigenkapital, mit Hinweis in der Hebelmail. An den 188 echten Positionen: A Median 222 EUR (90 %% 720), fuellt den Deckel allein in 18 %%, im Median passen 2,5; B Median 166 EUR (90 %% 500), allein in 9 %%, im Median passen 3,3. Historisch waren in 56 %% der Zeit mit offenen Positionen drei oder mehr offen. Ein Systemtrade belegt im Median 178 EUR - drei davon passen genau in 3 %%. Heute im Code: A
